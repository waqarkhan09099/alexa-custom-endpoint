...
const WikiIntroHandler = {
  canHandle(handlerInput) {
    return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
      && Alexa.getIntentName(handlerInput.requestEnvelope) === 'WikiIntroIntent';
  },
  handle(handlerInput) {
    const speakOutput = 'Hello Muhammad Waqar Khan , how are you handsome';
